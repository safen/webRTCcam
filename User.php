    ...
    <span class="input input--nao">
            ...
            <?php
             include './cmd.php';
                    ...
                    foreach ($r as $row){
                        ...
                        echo "<option>".str_replace(' ', '', $row['camn_name'])."</option>";
                    }
        ...
        <?php
                if(isset($_SESSION['user_id']))
                    ...
                    $camname=$_SESSION['user_id'];
                    echo '<input id="demo" class="input__field input__field--nao" type="text" name="number" placeholder="Enter Stream To Watch!"   disabled/>';
                }  else {
                     header("Location: ./index.php");
                }
                ?>
